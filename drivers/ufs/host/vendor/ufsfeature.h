...
/* Version info */
#define UFSFEATURE_DD_VER			0x020400
...
#define QUERY_FLAG_IDN_TW_UNPIN_EN			0x84
#endif
...
#define QUERY_ATTR_IDN_TW_BUF_PARTIAL_FLUSH_MODE	0x93
#define QUERY_ATTR_IDN_TW_PINNED_CURR_BUF_SIZE		0x94
#define QUERY_ATTR_IDN_TW_PINNED_AVAIL_BUF_SIZE		0x95
#define QUERY_ATTR_IDN_TW_PINNED_TOTAL_WRITTEN_SIZE	0x96
#define QUERY_ATTR_IDN_TW_PINNED_BUF_ALLOC_UNITS	0x9A
#define QUERY_ATTR_IDN_TW_MIN_NON_PINNED_BUF_ALLOC_UNITS 0x9B
#endif
#if defined(CONFIG_UFSHID)
