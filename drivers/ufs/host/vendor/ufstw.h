...
#define UFSTW_DD_VER					0x020800
#define UFSTW_DD_VER_POST				""

#define UFSTW_LIFETIME_WRITE_SECT_INTERVAL_DEFAULT	2097152  /* 1GB */
#define UFSTW_RESIZE_WRITE_SECT_INTERVAL_DEFAULT	524288	 /* 256MB */
#define UFSTW_RESIZE_WRITE_SECT_INTERVAL_MIN		524288   /* 256MB */
#define UFSTW_RESIZE_WRITE_SECT_INTERVAL_MAX		20971520 /* 10GB */

#define UFSTW_MAX_LIFETIME_VALUE			0x0B
#define UFSTW_LIFETIME_NOT_GURANTEE_BIT			7
#define MASK_UFSTW_LIFETIME_NOT_GUARANTEE		(1 << UFSTW_LIFETIME_NOT_GURANTEE_BIT)
...
#else
#define TW_DEBUG(tw, msg, args...)	do { } while (0)
#endif
